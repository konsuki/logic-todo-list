export const translations = {
  ja: {
    ...
    settings: {
      ...
      show_node_type_tags: 'ノードタイプを表示',
      show_node_type_tags_desc: 'タスクの種類（GOAL, STRATEGY等）を示すタグを表示します。',
      show_step_badges: 'ステップ番号を表示',
      show_step_badges_desc: '階層内での順番（Step 1, Step 2等）を表示します。',
      bulk_import: '一括インポート',
  ...
  en: {
    ...
    inspector: {
      ...
      tracking_in_progress: 'In progress',
    ...
    tree: {
      ...
      labelGapV: 'Label Gap (V)',
      hierarchyGap: 'Hierarchy Gap',
    },
    ai: {
    ...
    settings: {
      ...
      show_node_type_tags: 'Show Node Types',
      show_node_type_tags_desc: 'Show tags indicating task types (GOAL, STRATEGY, etc.).',
      show_step_badges: 'Show Step Numbers',
      show_step_badges_desc: 'Show sequence numbers (Step 1, Step 2, etc.) within each level.',
