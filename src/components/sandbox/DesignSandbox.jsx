  ...
  return (
    <div
      ...
      style={{
        ...
        alignItems: 'center',
        minHeight: '100%',
        background: isLight ? 'linear-gradient(135deg, #F8FAFC 0%, #F1F5F9 100%)' : '#0B0E14',
        padding: '20px',
        gap: '24px',
    ...
    >
      ...
      <motion.div
        layout
        style={{
          background: isLight ? 'rgba(255, 255, 255, 0.8)' : 'linear-gradient(180deg, #1A1F26 0%, #151921 100%)',
          backdropFilter: 'blur(20px)',
          WebkitBackdropFilter: 'blur(20px)',
          border: isLight ? '1px solid rgba(255, 255, 255, 0.5)' : '1px solid rgba(255, 255, 255, 0.08)',
          borderRadius: '24px',
          padding: '32px',
          width: '400px',
          boxShadow: isLight
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            開発者に好まれる「ミッドナイト・グレー」をベースに、 インディゴのアクセントを加えた洗練された配色案です。
          </p>
            ...
            style={{
              ...
              background: isCompleted
                ...
                : isLight
                  ? '#1E293B'
                  : '#F8FAFC',
              color: isCompleted ? (isLight ? '#16A34A' : '#4ADE80') : isLight ? 'white' : '#0B0E14',
              border: 'none',
              fontSize: '15px',
              fontWeight: '600',
              cursor: 'pointer',
