...
import { parseImportData } from '../../lib/importLogic';
      ...
      {isOpen && (
        <div className="modal-backdrop-container">
          <motion.div
            ...
            onClick={onClose}
          />
          <motion.div className="import-modal" variants={modalVariants} initial="hidden" animate="visible" exit="exit">
            ...
            <div className="modal-content">
              ...
              <div className="input-container">
                <textarea
                  ...
                  placeholder={
                    t('settings.bulk_import_placeholder') ||
                    'Example:\nMy Project\n  Strategic Goal\n    Task 1\n    Task 2'
                  }
                  value={inputText}
                  onChange={(e) => {
            ...
            <div className="modal-footer">
              ...
              <button className="primary-btn" onClick={handleImport} disabled={!inputText.trim()}>
                <Check size={18} />
